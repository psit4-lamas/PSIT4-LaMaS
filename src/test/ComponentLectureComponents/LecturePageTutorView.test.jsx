...
describe('LecturePagTutorView', () => {
    it('renders without crashing', () => {
        ...
        shallow(<LecturePageTutorView { ...props } />, div);
        ReactDOM.unmountComponentAtNode(div);
    });

    const saveSubject = jest.fn().mockResolvedValue({ message: 'success' });
    const props = {
        isEditMode: false,
        saveSubject,
        t: (key) => key,
    ...
    let lecturePageTutorViewComponent;

    beforeEach(() => {
        const component = <LecturePageTutorView { ...props } />;

        lecturePageTutorViewComponent = shallow(component);
    });

    afterEach(() => {
        lecturePageTutorViewComponent.unmount();
    });

    it('should render correctly', () => {
        expect(lecturePageTutorViewComponent).toMatchSnapshot();
    });
    ...
    it('should render correctly after mode change to edit', () => {
        const component = <LecturePageTutorView { ...props } />;

        lecturePageTutorViewComponent = shallow(component);
        lecturePageTutorViewComponent.instance().onModeChange(null, { value: 'edit' });
        expect(lecturePageTutorViewComponent).toMatchSnapshot();
    });

    it('should render correctly after mode from edit back to view', () => {
        const component = <LecturePageTutorView { ...props } />;

        lecturePageTutorViewComponent = shallow(component);
        lecturePageTutorViewComponent.instance().onModeChange(null, { value: 'edit' });
        lecturePageTutorViewComponent.instance().onModeChange(null, { value: 'view' });
        expect(lecturePageTutorViewComponent).toMatchSnapshot();
    });

    it('handles update of title correctly', () => {
        const component = <LecturePageTutorView { ...propsEditMode } />;

        lecturePageTutorViewComponent = shallow(component);
        lecturePageTutorViewComponent.instance().onModeChange(null, { value: 'view' });
        expect(lecturePageTutorViewComponent.state('isEditMode')).toBeTruthy();
        const updatedSubject = Object.assign({}, propsEditMode.subject);
        updatedSubject.lectures['lecture_01'].name = 'newLectureTitle';
    ...
    it('handles save of lecture correctly', () => {
        const component = <LecturePageTutorView { ...propsEditMode } />;
        ...
        lecturePageTutorViewComponent.find({ name: 'save' }).simulate('click');
